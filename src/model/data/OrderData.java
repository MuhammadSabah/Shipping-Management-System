...
public class OrderData {
    ...
    public boolean addOrder(Order ord) {
        Order order = new Order(ID_GENERATOR.intValue(), ord.shipmentId(), ord.orderWeight(), ord.shippingInvoice(), ord.itemsList(), ord.orderSender(), ord.orderReceiver(), ord.receiverAddress(), ord.deliveredDate(), ord.shippingDate(), ord.status());
