...
public class EmployeeData {
    ...
    public boolean addEmployee(Employee emp) {
        Employee employee = new Employee(ID_GENERATOR.intValue(), emp.username().toLowerCase(), emp.password().toLowerCase(), emp.address(), emp.age(), emp.gender(), emp.phoneNumber(), emp.email());
