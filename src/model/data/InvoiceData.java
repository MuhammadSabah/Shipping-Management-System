...
public class InvoiceData {
    ...
    public boolean addInvoice(Invoice inv) {
        Invoice invoice = new Invoice(ID_GENERATOR.getAndIncrement(), inv.shipmentId(), inv.invoiceDate(), inv.shipmentDate(), inv.shipmentType(), inv.note(), inv.boxesQuantity(), inv.price(), inv.totalAmount(), inv.discount(), inv.finalAmount(), inv.payedIn(), inv.CBM());
